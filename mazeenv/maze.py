# Modified from https://github.com/microsoft/MazeExplorer/blob/5c80af318e9497792034b05f2ee7374d70ad45ae/mazeexplorer/maze.py
...
def generate_mazes(maze_id, num=1, rows=9, columns=9, seed=None, complexity=.7, density=.7,
                   maze_layout=None):
    """
    args: 
    maze_id: 
    ...
    if maze_layout is not None:
        maze_path = "{}_MAP{:02d}.txt".format(maze_id, 1)
        with open(maze_path, 'w') as file:
            file.write(maze_layout)
        return
